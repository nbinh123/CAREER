...
// "Đồ chiên", "Lẩu"...). Nhóm tab được suy ra trực tiếp từ dữ liệu món ăn
// thật trả về từ /api/foods; món nào thiếu categoryId (null/rỗng) được gom
// vào nhóm "Khác". Phần này GIỮ NGUYÊN so với bản gọi món tại bàn — menu
// hiển thị y hệt như hiện tại theo đúng yêu cầu.
...
// Khác với bản gốc: trang này KHÔNG còn được gác bởi TableGuard (không có
// khái niệm bàn/QR nữa) nên luôn render được ngay khi vào app.
//
// Vẫn giữ bộ lọc "ẩn Food combo trái cây khỏi menu" (isComboFoodItem) như
// bản gốc: combo trái cây (Food document categoryId = "Trái cây mix") chỉ
// bán qua trang riêng /fruits, không hiển thị lẫn trong Thực đơn.
export default function MenuPage() {
  ...
  // Khoá scroll nền khi modal chi tiết món đang mở
  useEffect(() => {
  ...
  return (
    <div>
      ...
      {/* Modal chi tiết món — hard-code trực tiếp ở đây, giống bản gốc. */}
      {selectedItem && (
