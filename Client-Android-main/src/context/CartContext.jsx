...
// Y hệt bản web (src/context/CartContext.jsx) 100% — logic giỏ hàng không hề
// đụng tới DOM/localStorage nên copy nguyên. Giỏ hàng mobile sống trong bộ
// nhớ của phiên app (không cần persist qua AsyncStorage): khách đã đăng
// nhập, tắt app dở giỏ hàng thì coi như huỷ, không có yêu cầu nào trong kế
// hoạch nói phải giữ giỏ hàng qua các lần mở app.
